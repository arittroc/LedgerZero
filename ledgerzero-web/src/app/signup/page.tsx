...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Immediately log in to set the session cookie
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder-gray-600 transition-colors focus:border-white/30 focus:outline-none"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 pr-11 text-sm text-white placeholder-gray-600 transition-colors focus:border-white/30 focus:outline-none"
                  />
                  <button
                    type="button"
